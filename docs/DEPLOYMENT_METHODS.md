...
- The active deploy template targets a primary app plus an optional secondary app.
...
- The alternate pipeline can target primary, secondary, and third App Service names from the same package.
